import exerciseRawData from '../data/exerciseRaw.json'
...
//this is where you bring in the model reating a function to seed our database by removing everything and uploading a fresh set of data (using the map function from above).  Used to 'reset' a database without manual effort.  This is an anonomyous function, there's no need to name it.  All logic exists within the try block.  Mongoose will communicate with our database, whenever we use the capitol M Monarch term.
...
//this will execute our function
